...
// Public function to open the signature pad modal
...
function initEPod() {
    ...
    if (eSignatureBtn) {
        eSignatureBtn.addEventListener('click', () => {
            ...
            // Get first selected DR (in a real app, you might handle multiple)
            let drNumber = '';
            let customerName = '';
            let customerContact = '';
            let truckPlate = '';
            ...
            if (activeDeliveriesView && activeDeliveriesView.classList.contains('active')) {
                ...
                drNumber = selectedRows[0].closest('tr').querySelector('td:nth-child(2)').textContent;
            }
